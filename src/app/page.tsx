...
export default function Home() {
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* Me */}
      <section id="me" className="max-w-6xl mx-auto px-4 sm:px-8 py-14 sm:py-20">
        <Presentation />
      </section>
      ...
      {/* Skills */}
      <section id="skills" className="max-w-6xl mx-auto px-4 sm:px-8 py-14 sm:py-20">
        <Skills />
      </section>
      ...
      {/* Resume */}
      <section id="resume" className="max-w-6xl mx-auto px-4 sm:px-8 py-14 sm:py-20">
        <Resume />
      </section>
