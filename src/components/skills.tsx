...
const Skills = () => {
  ...
  return (
    ...
    >
      <Card className="w-full border-none px-0 pb-4 shadow-none">
        <CardHeader className="px-0 pb-1 pt-2">
          <CardTitle className="text-primary px-0 text-lg sm:text-xl font-bold">
            Skills & Expertise
          </CardTitle>
        </CardHeader>
              ...
              >
                ...
                >
                  {section.skills.map((skill, idx) => (
                    ...
                    >
                      <Badge className={`border px-2 py-0.5 font-normal text-xs`}>
                        {skill}
                      </Badge>
                    </motion.div>
                  ))}
