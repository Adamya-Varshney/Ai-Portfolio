  ...
  return (
    <div className="mx-auto w-full py-2 font-sans">
      ...
      <motion.div
        ...
        style={{ border: '1px solid rgba(99,102,241,0.18)', boxShadow: '0 2px 16px rgba(99,102,241,0.08)' }}
      >
        {/* Preview bar */}
        <div className="px-3 py-2 flex items-center justify-between"
          style={{ background: 'linear-gradient(145deg, rgba(99,102,241,0.08), rgba(168,85,247,0.06))', borderBottom: '1px solid rgba(99,102,241,0.15)' }}>
